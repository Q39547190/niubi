...
中车专属破解
无忧短视频
下载地址 https://wyhuiyuan.com?code=P5KGFRX
*******************************
[rewrite_local]
# > 无忧破解解全部视频
^https:\/\/qazwha5.com.+(videoPlayer|columnstRecommend).+ url script-request-header https://raw.githubusercontent.com/Q39547190/niubi/main/yaoci.js
...
if ($request_url.indexOf("columnstRecommend") != -1) {
var __Tis = ["mdsq crack", "url", "headers", "X-Api-UserAgent", "hasOwnProperty", ">_  一一中车专属破解(瑶池)一一 🛠", ">_ *****破解代码已注入*****❕", "", "msg", "done"];
