...
var headImage = /"headImage":".*?"/g;
var uniqueId = /"uniqueId":\d+/g;
...
body = body.replace(content,'"content": "<p>中车专属破解-加藤视频🚗</p><p>破解已注入‼️</p><p>成功破解永久VIP⚠️⚠️</p>金币💰视频需要弹窗观看⚠️⚠️⚠️<p>&nbsp;</p>"');
...
body = body.replace(nickname,'"nickname": "中车大神"').replace(userVip,'"userVip": 1').replace(expiredTime,'"expiredTime": 32493859951000').replace(headImage,'"headImage": "/group1/M00/C4/93/rB8AtGP0jiWAXPElAAFa4YasvOk261.jpg"').replace(uniqueId,'"uniqueId":88888888');
$done({
    body
});
}
