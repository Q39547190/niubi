...
[rewrite_local]
# > QQ传媒破解全部视频
^http[s]?:\/\/.+ludeng.+watch9.+m3u8.+ url script-request-header https://raw.githubusercontent.com/Q39547190/niubi/main/qqchuanmei.js
...
var __Tis = ["mdsq crack", "url", "headers", "X-Playback-Session-Id", "hasOwnProperty", ">_  一一一一中车专属破解QQ传媒一一一一 🛠", ">_ 点击一下此通知即可在线观看 🔞", "", "msg", "done"];
const $ = new Env(__Tis[0x0]);
let __0xed7e9 = $request[__Tis[0x1]];
let __qingqiu = $request[__Tis[0x2]];
let __url = __0xed7e9.replace(/https:\/\/120play/g, "iplayer:\/\/:\/删掉这里https:\/\/long");
